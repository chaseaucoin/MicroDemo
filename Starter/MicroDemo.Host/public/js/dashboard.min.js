...
"use strict"; angular.module("RDash").config(["$stateProvider", "$urlRouterProvider", function (t, e)
{
    ...
    .state("addCustomer", { url: "/addCustomer", templateUrl: "templates/addCustomer.html" })
    .state("customers", { url: "/customers", templateUrl: "templates/customers.html" })
    .state("editInvoice", { url: "/editInvoice/:id", templateUrl: "templates/editInvoice.html" })
    .state("cache", { url: "/cache", templateUrl: "templates/cache.html" })
}]);
...
function MasterCtrl(t, e) {
    var g = 992; t.getWidth = function () { return window.innerWidth }, t.$watch(t.getWidth, function (o, n) { o >= g ? angular.isDefined(e.get("toggle")) ? t.toggle = !!e.get("toggle") : t.toggle = !0 : t.toggle = !1 }), t.toggleSidebar = function () { t.toggle = !t.toggle, e.put("toggle", t.toggle) }, window.onresize = function () { t.$apply() }
}
